var imageJson = (function(){
  ...
  var addFigures = function(container, callback){
    ...
    for (var i = 0; i < this.length; i++) {
      var figure = '<figure data-tag=' + this[i].tag + '> <a href=' + this[i].image_link + ' class="photostack-img"><img src=' + this[i].image_url + ' alt="img04"/></a> <figcaption> ' + this[i].caption + ' for tag: ' + this[i].tag + ' </figcaption> </figure>'
      imageList += figure;
    }
